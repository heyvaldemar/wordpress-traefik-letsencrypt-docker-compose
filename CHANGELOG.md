...
- **`wordpress:7.1.1` moved to `wordpress:7.1.2`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`wordpress:7.1.0` moved to `wordpress:7.1.1`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`wordpress:7.1.0` was rebuilt upstream**; the pin moved from `sha256:5a93c470ae82…` to `sha256:74103f21d460…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
[Unreleased]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.6...HEAD
[1.8.6]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.5...v1.8.6
[1.8.5]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.4...v1.8.5
[1.8.4]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.3...v1.8.4
[1.8.3]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.2...v1.8.3
[1.8.1]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.8.0...v1.8.1
[1.8.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.7.0...v1.8.0
[1.7.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/heyvaldemar/wordpress-traefik-letsencrypt-docker-compose/compare/v1.1.0...v1.2.0
